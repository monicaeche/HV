...
\begin{cventries}
    ...
    \cventry{Beca por excelencia  Maestría Igualdad de Género en ámnito público y privado}{Universidad Jaime I}{Castellón de la Playa, España}{2016}{}\vspace{-4.0mm}
\end{cventries}

\hypertarget{experiencia-laboral-acaduxe9mica}{%
\section{Experiencia Laboral
Académica}\label{experiencia-laboral-acaduxe9mica}}
...
\item Paula Andrea Moncada, 'Análisis crítico discursivo con enfoque de género del cubrimiento periodístico de los casos de explotación sexual infantil en Colombia' (2021)
...
\item Angie Natalia Acosta, 'Discursos ciberfeministas en la red social de TikTok' (2021)
...
\item Olga Ochoa, 'Análisis de las estrategias de comunicación de los movimientos sociales feministas que lograron la despenalización parcial del aborto en Colombia' (2019)
